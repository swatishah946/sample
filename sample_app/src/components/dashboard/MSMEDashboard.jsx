...
const shipments = [
  { id: "SH001", from: "Mumbai", to: "Delhi", cost: 0, status: "In Transit", icon: <FaTruck className="text-blue-500" /> },
  { id: "SH002", from: "Bangalore", to: "Chennai", cost: 0, status: "Pending", icon: <FaClock className="text-yellow-500" /> },
  { id: "SH003", from: "Pune", to: "Hyderabad", cost: 0, status: "Delivered", icon: <FaCheckCircle className="text-green-500" /> },
];

const loadMatches = [
  { matchScore: 0, savings: 0 },
  { matchScore: 0, savings: 0 },
];
          ...
          <Card key={shipment.id} className="mb-4 shadow-lg rounded-lg">
            <CardContent className="flex justify-between items-center p-4">
              <div>
                ...
                <div className="text-lg font-bold text-blue-600">₹{shipment.cost.toLocaleString()}</div>
          ...
          <Card className="p-6 shadow-lg rounded-lg">
            <CardContent>
              ...
              <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input type="text" className="p-2 border rounded" placeholder="First Name*" required />
                <input type="text" className="p-2 border rounded" placeholder="Last Name*" required />
                <input type="email" className="p-2 border rounded" placeholder="Email*" required />
                <input type="text" className="p-2 border rounded" placeholder="Phone Number*" required />
                <input type="text" className="p-2 border rounded" placeholder="Company Name*" required />
                ...
                <input type="text" className="p-2 border rounded" placeholder="City" required />
                ...
                <Button className="col-span-2 mt-4 bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-lg">
                  Submit
                </Button>
              </form>
            </CardContent>
